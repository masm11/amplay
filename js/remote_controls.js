...
MediaRemoteControls.prototype._setupBluetooth = function(callback) {
  ...
  if (this.bluetooth) {
    ...
    set_msg('_setupBluetooth: 1.2');
  } else {
    set_msg('_setupBluetooth: no mozBluetooth.');
    console.warn('No mozBluetooth');
  }

  function initialDefaultAdapter() {
    set_msg('_setupBluetooth: 1.3');
    var request = self.bluetooth.getDefaultAdapter();
    set_msg('_setupBluetooth: 1.4');
...
MediaRemoteControls.prototype._commandHandler = function(message) {
  set_msg('_commandHandler: 0: ' + message);
  var type = 'remote';
  var option = {};
